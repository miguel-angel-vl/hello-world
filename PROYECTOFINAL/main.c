...
int jugar(JUGADOR **usuarios, int *, int *indscore);
...
int oneplayer(JUGADOR *registrados, int ind, int *indscore);
...
int jugar(JUGADOR **usuarios, int *ind, int *indscore){
    ...
    do{
        ...
        switch(opc)
        {
            ...
            case '2':
                ...
                oneplayer(*usuarios, ind, indscore);
                break;
...
int oneplayer(JUGADOR *registrados, int ind, int *indscore){
    ...
    int user, score = 0, total = 0, cant = 0;
    char categoria, nom[MAXCARACT], pass[MAXPASS];
    FILE *arch;
...
int multiplayer(JUGADOR *registrados, int cant)
{
    int user1, user2, total = 0, cont = 1, score1, score2;
    char categoria, nom1[MAXCARACT], nom2[MAXCARACT], pass1[MAXPASS], pass2[MAXPASS];
...
int quickgame(JUGADOR *registrados, int cant){
    ...
    int user, total = 0, result, categoria;
    char nom[MAXCARACT], pass[MAXPASS];
...
//
//
//    cantusers = (int) (tamarch(arch) / sizeof(JUGADOR));
//    usu = (JUGADOR *) malloc(cantusers*sizeof(JUGADOR));
//printf(" Entra Cantusers %d...\n",cantusers);
//    fread(usu, sizeof(JUGADOR), cantusers, arch);
