...
JUGADOR *registro(JUGADOR *registrados, int ind, FILE *);
int passwordlen(JUGADOR *usuario);
void getpassword(JUGADOR *usuario);
int existusuario(JUGADOR *usu, int n, char *nombre, FILE*);
...
int main()
{
    ...
    do{
        ...
        printf("MENU\n");
        gotoxy(30,7);
        printf("1.JUGAR         2.AYUDA         3.SALIR\n");
...
JUGADOR *registro(JUGADOR *registrados, int ind, FILE *arch){
    ...
    if(ind == total){
        total += CANTINI;
        registrados = (JUGADOR *)realloc(registrados, total * sizeof(JUGADOR));
    }
    ...
    do{
        ...
        else if ( existusuario(registrados,ind,nomusu,arch) != -1)
            printf("Este nombre ya est%c asignado\n\n",160);

    }while((strlen(nomusu) > MAXCHAR-1 || nomusu[0] == '\0') || existusuario(registrados,ind,nomusu, arch) != -1);
    ...
    //fwrite(&ind, sizeof(int), 1, arch);
    fwrite(&registrados[ind], sizeof(JUGADOR), ind, arch);
    fclose(arch);

    return registrados;
}

int oneplayer(JUGADOR *registrados, int cant, FILE *arch){

    int opc, user, indscore = 0, total = 0;
    char categoria, nom[MAXCHAR], pass[MAXPASS];
    ...
    do
    {
        ...
        user = existusuario(registrados, cant, nom, arch);
    ...
    //registrados[user].highscore = (int*)malloc(CANTINI*sizeof(int));
    ...
    /*if(total == CANTINI){
        registrados[user].highscore = (int*)realloc(registrados[user].highscore, (total+2)*sizeof(int));
        total = 0;
    }
*/
    return 1;
...
int multiplayer(JUGADOR *registrados, int cant, FILE *arch)
{
    int opc, user1, user2, indscore = 0, total = 0, cont = 1, score1, score2;
    char categoria, nom1[MAXCHAR], nom2[MAXCHAR], pass1[MAXPASS], pass2[MAXPASS];
    ...
    do
    {
        ...
        user1 = existusuario(registrados, cant, nom1, arch);
    ...
    do
    {
        ...
        user2 = existusuario(registrados, cant, nom2, arch);
    ...
    gotoxy(35,2);
    printf("%cBIENVENIDOS \" %s Y %s\"!",173,registrados[user1].nombre, registrados[user2].nombre);
    gotoxy(30,3);
    printf("SELECCIONE LA CATEGORIA EN LA QUE DESEA JUGAR:\n\n");
    printf("1. Series de TV\n");
    printf("2. Pel%cculas\n", 161);
            ...
            case '1':
                do{
                    if(cont == 1){
                        ...
                        system("cls");
                        printf("**********SERIES de TV**********\n\n");
                        score1 = series(registrados[user1], 0);
                    }else{
                        system("cls");
                        printf("**********SERIES de TV**********\n\n");
                        ...
                        system("cls");
                        printf("**********SERIES de TV**********\n\n");
                        score2 = series(registrados[user2], 0);
                    }
                    cont++;
            ...
            case '2':
                do{
                    if(cont == 1){
                        ...
                        system("cls");
                        printf("**********PELICULAS**********\n\n");
                        score1 = peliculas(registrados[user1],0);
                    }else{
                        system("cls");
                        printf("**********PELICULAS**********\n\n");
                        printf("TURNO DE %s!\n", registrados[user2].nombre);
                        ...
                        system("cls");
                        printf("**********PELICULAS**********\n\n");
                        score2 = peliculas(registrados[user2], 0);
                    }
                    cont++;
            ...
            case '3':
                do{
                    if(cont == 1){
                        ...
                        system("cls");
                        printf("**********HISTORIA**********\n\n");
                        score1 = historia(registrados[user1], 0);
                    }else{
                        system("cls");
                        printf("**********HISTORIA**********\n\n");
                        printf("TURNO DE %s!\n", registrados[user2].nombre);
                        ...
                        system("cls");
                        printf("**********HISTORIA**********\n\n");
                        score2 = historia(registrados[user2], 0);
                    }
                    cont++;
                }while (cont < 3);
            ...
            case '4':
                do{
                    if(cont == 1){
                        ...
                        system("cls");
                        printf("**********GEOGRAFIA**********\n\n");
                        score1 = geografia(registrados[user1], 0);
                    }else{
                        system("cls");
                        printf("**********GEOGRAFIA**********\n\n");
                        printf("TURNO DE %s!\n", registrados[user2].nombre);
                        ...
                        system("cls");
                        printf("**********GEOGRAFIA**********\n\n");
                        score2 = geografia(registrados[user2], 0);
                    }
                    cont++;
                }while (cont < 3);
            ...
            case '5':
                do{
                    if(cont == 1){
                        ...
                        system("cls");
                        printf("**********DEPORTES**********\n\n");
                        score1 = deporte(registrados[user1], 0);
                    }else{
                        system("cls");
                        printf("**********DEPORTES**********\n\n");
                        printf("TURNO DE %s!\n", registrados[user2].nombre);
                        ...
                        system("cls");
                        printf("**********DEPORTES**********\n\n");
                        score2 = deporte(registrados[user2], 0);
                    }
                    cont++;
                }while (cont < 3);
            ...
            case '6':
                do{
                    if(cont == 1){
                        ...
                        system("cls");
                        printf("**********MUSICA**********\n\n");
                        score1 = musica(registrados[user1], 0);
                    }else{
                        system("cls");
                        printf("**********MUSICA**********\n\n");
                        printf("TURNO DE %s!\n", registrados[user2].nombre);
                        ...
                        system("cls");
                        printf("**********MUSICA**********\n\n");
                        score2 = musica(registrados[user2], 0);
                    }
                    cont++;
                }while (cont < 3);
...
int quickgame(JUGADOR *registrados, int cant, FILE *arch){

    int opc, user, indscore = 0, total = 0, result, categoria;
    char nom[MAXCHAR], pass[MAXPASS];
    ...
    switch(categoria){
        ...
        case 1:
            ...
            system("cls");
            printf("**********SERIES de TV**********\n\n");
            result = series(registrados[user], 1);
            printf("SU RESULTADO FUE %d!", result);
            break;
        ...
        case 2:
            ...
            system("cls");
            printf("**********PELICULAS**********\n\n");
            result = peliculas(registrados[user], 1);
            printf("SU RESULTADO FUE %d!", result);
            break;
        ...
        case 3:
            ...
            system("cls");
            printf("**********HISTORIA**********\n\n");
            result = historia(registrados[user], 1);
            printf("SU RESULTADO FUE %d!", result);
            break;
        ...
        case 4:
            ...
            system("cls");
            printf("**********GEOGRAFIA**********\n\n");
            result = geografia(registrados[user], 1);
            printf("SU RESULTADO FUE %d!", result);
            break;
        ...
        case 5:
            ...
            system("cls");
            printf("**********DEPORTES**********\n\n");
            result = deporte(registrados[user], 1);
            printf("SU RESULTADO FUE %d!", result);
            break;
        ...
        case 6:
            ...
            system("cls");
            printf("**********MUSICA**********\n\n");
            result = musica(registrados[user], 1);
            printf("SU RESULTADO FUE %d!", result);
            break;
...
int series(JUGADOR *usuario, int quick)
{
    int valsinds[MAXPREGS];
    int ind, num, vidas, n = MAXPREGS, rightans, score = 0;
    char respusu;
...
int peliculas(JUGADOR *usuario, int quick)
{
    int valsinds[MAXPREGS];
    int ind, num, vidas, n = MAXPREGS, rightans, score = 0;
    char respusu;
...
int historia(JUGADOR *usuario, int quick)
{
    int valsinds[MAXPREGS];
    int ind, num, vidas, n = MAXPREGS, rightans, score = 0;
    char respusu;
...
int geografia(JUGADOR *usuario, int quick)
{
    int valsinds[MAXPREGS];
    int ind, num, vidas, n = MAXPREGS, rightans, score = 0;
    char respusu;
...
int deporte(JUGADOR *usuario, int quick)
{
    int valsinds[MAXPREGS];
    int ind, num, vidas, n = MAXPREGS, rightans, score = 0;
    char respusu;
...
int musica(JUGADOR *usuario, int quick)
{
    int valsinds[MAXPREGS];
    int ind, num, vidas, n = MAXPREGS, rightans, score = 0;
    char respusu;
...
int preguntapelicula(int aleat){
    ...
    switch(aleat){
        ...
        case 4:
            printf("%cQu%c descubre Truman Burbank en la pel%ccula The Truman Show?", 168, 130, 161);
        ...
        case 12:
            printf("%cQui%cn hace el papel de Seth en la pelicula Superbad?",168,130);
            printf("a) Jonah Hill\n");
            printf("b) Seth Rogen\n");
...
int preguntacultura(int aleat){

    int ran = randrango(0, MAXPREGS-1);

    switch(aleat){

        case 1:
            return preguntaseries(ran);
            break;
        case 2:
            return preguntapelicula(ran);
            break;
        case 3:
            return preguntamusica(ran);
            break;
        case 4:
            return preguntahistoria(ran);
            break;
        case 5:
            return preguntageografia(ran);
            break;
        case 6:
            return preguntadeportes(ran);
            break;
        default:
            return -1;
            break;
